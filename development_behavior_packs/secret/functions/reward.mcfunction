...
execute as @s[scores={timer=1..30}] run particle minecraft:glow_particle 0 1 0 1 -423 70 -406 0.1 0.1 0.1 0.5 8 normal
...
execute as @s[scores={timer=5,health=60..}] run playsound minecraft:entity.item.pickup @a -423 70 -406
...
execute as @s[scores={timer=5},tag=20hearts] run playsound minecraft:entity.item.pickup @a -423 70 -406
...
execute as @s[scores={timer=10,health=58..}] run playsound minecraft:entity.item.pickup @a -423 70 -406
# and/ or Player Rerolled
#execute as @s[scores={timer=10},tag=20hearts] run summon item -423 70 -406 {Item:{id:"minecraft:gold_block",Count:1b}}
execute as @s[scores={timer=10},tag=20hearts] run playsound minecraft:entity.item.pickup @a -423 70 -406
...
execute as @s[scores={timer=15,health=56..}] run playsound minecraft:entity.item.pickup @a -423 70 -406
# and/or Player Rerolled
...
execute as @s[scores={timer=15},tag=20hearts] run playsound minecraft:entity.item.pickup @a -423 70 -406
...
execute as @s[scores={timer=20,health=54..}] run playsound minecraft:entity.item.pickup @a -423 70 -406
# and/or Player Rerolled
#execute as @s[scores={timer=20},tag=20hearts] run summon item -423 70 -406 {Item:{id:"minecraft:gold_block",Count:1b}}
execute as @s[scores={timer=20},tag=20hearts] run playsound minecraft:entity.item.pickup @a -423 70 -406
...
execute as @s[scores={timer=25,health=52..}] run playsound minecraft:entity.item.pickup @a -423 70 -406
#and/ or Player Rerolled
...
execute as @s[scores={timer=25},tag=20hearts] run playsound minecraft:entity.item.pickup @a -423 70 -406
...
execute as @s[scores={timer=30,health=50..}] run playsound minecraft:entity.item.pickup @a -423 70 -406
# and/or Player Rerolled
#execute as @s[scores={timer=30},tag=20hearts] run summon item -423 70 -406 {Item:{id:"minecraft:ancient_debris",Count:1b}}
execute as @s[scores={timer=30},tag=20hearts] run playsound minecraft:entity.item.pickup @a -423 70 -406
...
execute as @s[scores={timer=35,health=48..}] run playsound minecraft:entity.item.pickup @a -423 70 -406
# and/or Player Rerolled
...
execute as @s[scores={timer=35},tag=20hearts] run playsound minecraft:entity.item.pickup @a -423 70 -406
...
execute as @s[scores={timer=40,health=46..}] run playsound minecraft:entity.item.pickup @a -423 70 -406
# and/or Player Rerolled
...
execute as @s[scores={timer=40},tag=20hearts] run playsound minecraft:entity.item.pickup @a -423 70 -406
...
execute as @s[scores={timer=45,health=44..}] run playsound minecraft:entity.item.pickup @a -423 70 -406
# and/or Player Rerolled
#execute as @s[scores={timer=45},tag=20hearts] run summon item -423 70 -406 {Item:{id:"minecraft:golden_apple",Count:1b}}
execute as @s[scores={timer=45},tag=20hearts] run playsound minecraft:entity.item.pickup @a -423 70 -406
...
execute as @s[scores={timer=50,health=42..}] run playsound minecraft:entity.item.pickup @a -423 70 -406
# and/or Player Rerolled
#execute as @s[scores={timer=50},tag=20hearts] run summon item -423 70 -406 {Item:{id:"minecraft:iron_block",Count:1b}}
execute as @s[scores={timer=50},tag=20hearts] run playsound minecraft:entity.item.pickup @a -423 70 -406

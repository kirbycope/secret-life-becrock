...
execute as @s[scores={timer=80,session1=1,session2=0,session3=0,session4=0,session5=0}] run function session1
execute as @s[scores={timer=80,session1=1,session2=1,session3=0,session4=0,session5=0}] run function session2
execute as @s[scores={timer=80,session1=1,session2=1,session3=1,session4=0,session5=0}] run function session3
execute as @s[scores={timer=80,session1=1,session2=1,session3=1,session4=1,session5=0}] run function session4
execute as @s[scores={timer=80,session1=1,session2=1,session3=1,session4=1,session5=1}] run function session5

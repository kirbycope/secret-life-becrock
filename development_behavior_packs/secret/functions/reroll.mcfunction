...
execute as @s[scores={s1fail=0,s1reroll=0,s1success=0}] run clear @s writable_book
...
execute as @s[scores={s1fail=0,s1reroll=0,s1success=0}] run give @s writable_book

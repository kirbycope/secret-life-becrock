...
execute as @s[scores={timer=80,s4fail=0,s4success=0},tag=session4] run function reroll4
execute as @s[scores={timer=80,s5fail=0,s5success=0},tag=session5] run function reroll5
execute as @s[scores={timer=80,s6fail=0,s6success=0},tag=session6] run function reroll6
